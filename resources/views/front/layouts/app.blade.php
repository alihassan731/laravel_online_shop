	...
	<div class="container">
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			...
			<div class="col-lg-6 col-6 text-left  d-flex justify-content-end align-items-center">
				...
				@else
				<a href="{{ route('account.login')}}" class="nav-link text-dark">Register/Login</a>
				@endif
...
<script src="{{ asset('front-assets/js/custom.js')}}"></script>ion.rangeSlider.min
...
function myFunction() {
  if (window.pageYOffset >= sticky) {
	...
	// when error CSRF Token mismatch then we below code mera tag write in head tag and ajax function write in script tag 
	//<meta name="csrf-token" content="{{ csrf_token()}}">
	$.ajaxSetup({
		headers: {
