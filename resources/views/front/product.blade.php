            ...
            <div class="col-md-7">
                <div class="bg-light right">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <small class="pt-2 ps-1">({{($product->product_ratings_count > 1)? $product->product_ratings_count.'
                            Reviews' : $product->product_ratings_count.' Review'}})</small>
                    </div>
            ...
            <div id="related-products" class="carousel">
                ...
                <div class="card product-card">
                    <div class="product-image position-relative">
                        <a href="{{ route('front.product',$relProducts->slug)}}" class="product-img">
                        ...
                        <a class="whishlist" onclick="addToWishList({{ $relProducts->id }})" href="javascript:void(0);">
                        ...
                        <div class="product-action">
                            ...
                            <a class="btn btn-dark" href="javascript:void(0);"
                                onclick="addToCart({{$relProducts->id}});">
                                <i class="fa fa-shopping-cart"></i> Add To Cart
                            </a>
                            @else
                            <a class="btn btn-dark" href="javascript:void(0);">
