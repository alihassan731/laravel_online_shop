            ...
            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <textarea name="order_notes" id="order_notes" cols="30" rows="2"
                                            placeholder="Order Notes (optional)" class="form-control">{{(!empty($customerAddress)) ? $customerAddress->notes : ''}}</textarea>
                                    </div>
                                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card payment-form ">
                        ...
                        <div class="card-body p-0 d-none mt-3" id="card-pament-form">
                            <div class="mb-3">
...
<script>
    $('#payment_method_one').click(function () {
        if ($(this).is(":checked")) {
            $("#card-pament-form").addClass("d-none");
        }
    });
    $('#payment_method_two').click(function () {
        if ($(this).is(":checked")) {
            $("#card-pament-form").removeClass("d-none");
        }
    });
