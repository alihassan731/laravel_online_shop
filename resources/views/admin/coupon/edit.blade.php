...
<section class="content">
    ...
    <div class="container-fluid">
        <form action="" method="post" class="discountForm" id="discountForm">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description" class="form-control" cols="30" rows="3" placeholder="Coupon Code description">{{$coupon->description}}</textarea>
                            </div>
                        </div>
...
$("#discountForm").submit(function(event){
    ...
    var element = $(this); // it means select the discountForm...
